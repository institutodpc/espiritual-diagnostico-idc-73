...
const WelcomePopup = ({ onStart }: WelcomePopupProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent 
        className="max-w-md mx-auto p-8 rounded-xl bg-white border border-purple-200 shadow-xl"
      ...
      >
        <DialogHeader className="space-y-6">
          ...
          <div id="dialog-description" className="text-center pt-2 space-y-4 text-gray-800">
            ...
            <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
              <span className="text-amber-800 text-sm">
                <strong>Observação:</strong> Após essa análise, você poderá desbloquear conteúdos e desafios personalizados.
              </span>
            </div>
          </div>
        </DialogHeader>
